...
void Deposit_calc::equal() {
    ...
    if (ui->lineEdit_loanAmount->text().isEmpty() || ui->lineEdit_term->text().isEmpty() ||
    ...
    double accrued_interest = get_total_ac(&amount, term, interest_rate, mode, capitalization,
